...
object LevelingConfig {
    ...
    val DURABILITY_EDITION = BUILDER.comment("耐久値を編集するかどうか").define("durabilityEdition", false)
    ...
    val MINIGAME_OVERLAY_HEIGHT = BUILDER.comment("").defineInRange("minigameOverlayHeight",0,  Int.MIN_VALUE, Int.MAX_VALUE)
